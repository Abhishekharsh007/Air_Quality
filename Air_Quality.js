...
const appId = "0326cca931ccb57fc374d97edcfc28c6";
...
const getUserLocation = () => {
    if(navigator.geolocation){
        ...
        onPositionGatherError({ message: "Can't access location. Please! Enter Co-ordinates." });
    }
}
...
const getAirQuality = async(lat,lon) => {
    ...
    // setValuesOfAir({ list: [{main: {aqi: 5} }] })
}
...
const setComponentsOfAir = airData => {
    ...
    componentsEle.forEach(ele => {
        ...
        ele.innerText = component[attr] += ' ppm';
    })
}
